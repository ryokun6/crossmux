...
| EPUB layout ([lib/Epub/Epub/ParsedText.cpp](../../lib/Epub/Epub/ParsedText.cpp), [CjkKinsoku.h](../../lib/Epub/Epub/CjkKinsoku.h)) | CJK punctuation rules (行頭/行末/分離 禁则) and full-width padding. Horizontal and vertical line breaks reject illegal 禁则 boundaries. |
