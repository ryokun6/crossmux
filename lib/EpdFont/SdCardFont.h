...
class SdCardFont {
 public:
  ...
  // advanceX from SD, and stores them in a sorted per-style table. Remaining
  // codepoints use the existing on-demand lookup path.
  ...
  // Like getAdvance(), but resolves a cache miss by reading the glyph's advanceX
