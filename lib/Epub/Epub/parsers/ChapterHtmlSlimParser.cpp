...
void ChapterHtmlSlimParser::flushPartWordBuffer() {
...
#ifdef ENABLE_CJK_VERSION
  {
    ...
    if (pendingRealSpace) {
      ...
      // CSS Text 4.1.2: a segment break between two no-space CJK characters is
      // removed; any other context (Hangul or non-CJK on either side) becomes a space.
...
#endif
  currentTextBlock->addWord(partWordBuffer, fontStyle, false, nextWordContinues, spaceBefore);
